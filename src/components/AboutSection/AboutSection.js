        ...
        <section className="py-36  sm:pt-24 relative " ref={aboutSection}>
            <div className="container mx-auto px-2">
                <div className="flex flex-col sm:flex-row gap-5">
                    ...
                    <div className="text-gray-300 pt-5  lg:pr-52 md:pr-24">
                        ...
                        <button className="bg-green-400 hover:bg-green-500 p-2 text-white rounded-md mr-3 mt-4 font-medium">Get Resume</button>
                        <button onClick={() => handleSectionView('skill')} className="rounded-md ring-2 ring-green-400  p-2  mt-4 text-white hover:text-green-400 font-medium">My Skill</button>
            ...
            <p className="text-white transform rotate-90
              ...
              text-xl tracking-wide about-me">About Me</p>
        </section>
    );
};
